...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'client');

		$('.daterangepicker_end_input').attr('data-grid', 'client');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('client', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
